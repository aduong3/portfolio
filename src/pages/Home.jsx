  ...
  return (
    <>
      <div className="flex flex-col items-center lg:flex-row">
        <section className="flex flex-col gap-4 px-2 text-center md:gap-8 lg:px-0 lg:text-left">
      ...
      <div className="flex items-center justify-center gap-5 lg:justify-normal lg:gap-12">
        <Link
          to="/projects"
          className="flex items-center gap-2 rounded-md bg-yellow-400 px-3 py-2 font-bold text-black hover:scale-110"
        >
          <MdOutlinePageview />
          View Projects
        </Link>
      ...
      <div className="mt-5 flex flex-col px-5 md:items-center">
        ...
        <div className="grid w-full grid-cols-4 justify-around gap-8 border-1 px-6 py-3 lg:w-[70%]">
